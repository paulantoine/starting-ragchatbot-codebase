...
class CourseOutlineTool(Tool):
    """Tool for getting course outline information"""
    ...
    def execute(self, course_name: str) -> str:
        ...
        """
        # Resolve course name using the vector store's course resolution
        ...
        try:
            ...
            if lessons_json:
                ...
                outline += f"**Lessons ({len(lessons)} total):**\n"
                ...
                outline += "**Lessons:** No lesson information available\n"
