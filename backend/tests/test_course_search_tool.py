...
class TestCourseSearchTool:
    ...
    def test_execute_with_both_filters(self, mock_vector_store, sample_search_results):
        ...
        # Execute
        result = tool.execute("testing concepts", course_name="Test Course", lesson_number=1)
    ...
    def test_execute_empty_results_with_both_filters(self, mock_vector_store, empty_search_results):
        ...
        # Execute 
        result = tool.execute("nonexistent content", course_name="Test Course", lesson_number=5)
    ...
    def test_source_tracking_reset_between_searches(self, mock_vector_store, sample_search_results):
