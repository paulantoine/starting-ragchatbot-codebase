...
"""
    ...
    def generate_response(self, query: str,
        ...
        if tools and tool_manager:
            return self._sequential_tool_calling(query, system_content, tools, tool_manager)
    ...
    def _sequential_tool_calling(self, query: str, system_content: str, 
        ...
        while round_count < self.MAX_TOOL_ROUNDS:
            ...
            if not tool_results:
                ...
                return response.content[0].text if response.content else "I apologize, but I encountered an error while processing your request."
